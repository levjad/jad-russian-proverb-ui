...
export const ProverbCard: React.FC<ProverbCardProps> = ({ proverb, onSpeakRussian, onSpeakEnglish }) => {
    return (
        <div className="flex flex-col gap-6 items-center">
            <h3 className="text-xs tracking-wider font-bold text-primary">PROVERB #{proverb.id}</h3>
            <div className="relative flex items-center justify-between gap-6">
                ...
                <button
                    className="btn btn-ghost btn-sm opacity-10 hover:opacity-100 transition-opacity duration-200"
            ...
            <div className="relative flex items-center justify-between gap-6 mt-2">
            ...
            <div className="card bg-base-100 w-full max-w-lg mx-auto">
